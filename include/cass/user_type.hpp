...
inline error user_type::set_float_by_name_n(
...
inline error user_type::set_string_n(size_t index, char const *value,
        size_t value_length)
{
    return (error)::cass_user_type_set_string_n(p, index, value, value_length);
}
...
inline error user_type::set_bytes(size_t index, byte_t const *value,
        size_t value_size)
{
    return (error)::cass_user_type_set_bytes(p, index, value, value_size);
}
...
{
    return (error)::cass_user_type_set_bytes_by_name_n(p, name, name_length,
            value, value_size);
}
...
inline error user_type::set_custom_n(size_t index, char const *class_name,
        size_t class_name_length, byte_t const *value, size_t value_size)
{
    return (error)::cass_user_type_set_custom_n(p, index, class_name,
        ...
        size_t name_length, byte_t const *varint, size_t varint_size, int scale)
{
    return (error)::cass_user_type_set_decimal_by_name_n(
            p, name, name_length, varint, varint_size, scale);
}

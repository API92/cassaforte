...
{
    return ::cass_error_result_code(p);
}
...
{
    return ::cass_error_result_keyspace(p, keyspace, keyspace_length);
}

inline error error_result::table(char const **tbl, size_t *tbl_length) const
{
    return ::cass_error_result_table(p, tbl, tbl_length);
}

inline error error_result::function(char const **function,
        size_t *function_length)
{
    return ::cass_error_result_function(p, function, function_length);
}
...
inline error error_result::arg_type(size_t index, char const **arg_type,
        size_t *arg_type_length) const
{
    return ::cass_error_result_arg_type(p, index, arg_type, arg_type_length);
}
